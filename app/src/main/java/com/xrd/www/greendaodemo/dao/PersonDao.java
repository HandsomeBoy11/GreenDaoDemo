...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Xueli = new Property(2, String.class, "xueli", false, "XUELI");
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // xueli
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setXueli(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
